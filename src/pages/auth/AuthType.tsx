            ...
            <IonContent>
                <div className='px-8 py-8 h-screen flex items-center justify-center'>
                    <div>
                        ...
                        <button className='w-full rounded-lg bg-[#8BD3E2] py-5 flex items-center justify-center my-4'><img src={account_circle} className='w-5 h-5 mr-4' />Login with Email</button>
                        <button className='flex justify-center w-full my-4 py-5 bg-white'>Register</button>
                    </div>
                </div>
            </IonContent>
        </IonPage>
